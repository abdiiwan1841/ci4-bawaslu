<!DOCTYPE html>
<!-- saved from url=(0027)https://eauditee.bpk.go.id/ -->
<html>
...
<head>
    ...
    <title>Selamat Datang - Di Portal E-Auditee Badan Pemeriksan Keuangan Indonesia - </title>
    <meta name="description" content="">

    <!-- Schema.org markup for Google+ -->
    <meta itemprop="name" content="Selamat Datang - Di Portal E-Auditee Badan Pemeriksan Keuangan Indonesia - ">
    <meta itemprop="description" content="">
    <meta itemprop="image" content="https://eauditee.bpk.go.id/storage/app/media/meta-image.png">

    <!-- Twitter Card data -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:site" content="@twitter">
    <meta name="twitter:title" content="Selamat Datang - Di Portal E-Auditee Badan Pemeriksan Keuangan Indonesia - ">
    <meta name="twitter:description" content="">

    <!-- Twitter summary card with large image must be at least 280x150px -->
    <meta name="twitter:image:src" content="https://eauditee.bpk.go.id/storage/app/media/meta-image.png">

    <!-- Open Graph data -->
    <meta property="og:title" content="Selamat Datang - Di Portal E-Auditee Badan Pemeriksan Keuangan Indonesia - ">
    <meta property="og:url" content="https://eauditee.bpk.go.id">
    <meta property="og:image" content="https://eauditee.bpk.go.id/storage/app/media/meta-image.png">
    ...
    <link rel="canonical" href="https://eauditee.bpk.go.id/">

    <!-- Favicons -->
    <link rel="apple-touch-icon" sizes="57x57" href="https://eauditee.bpk.go.id/apple-touch-icon-57x57.png">
    <link rel="apple-touch-icon" sizes="60x60" href="https://eauditee.bpk.go.id/apple-touch-icon-60x60.png">
    <link rel="apple-touch-icon" sizes="72x72" href="https://eauditee.bpk.go.id/apple-touch-icon-72x72.png">
    <link rel="apple-touch-icon" sizes="76x76" href="https://eauditee.bpk.go.id/apple-touch-icon-76x76.png">
    <link rel="apple-touch-icon" sizes="114x114" href="https://eauditee.bpk.go.id/apple-touch-icon-114x114.png">
    <link rel="icon" type="image/png" href="https://eauditee.bpk.go.id/favicon-32x32.png" sizes="32x32">
    <link rel="icon" type="image/png" href="https://eauditee.bpk.go.id/favicon-96x96.png" sizes="96x96">
    <link rel="icon" type="image/png" href="https://eauditee.bpk.go.id/favicon-16x16.png" sizes="16x16">
    <link rel="manifest" href="https://eauditee.bpk.go.id/manifest.json">
    <link rel="mask-icon" href="https://eauditee.bpk.go.id/safari-pinned-tab.svg" color="#333">
    ...
    <!-- Google Fonts -->
    <link rel="stylesheet" href="./Selamat Datang - Di Portal E-Auditee Badan Pemeriksan Keuangan Indonesia -_files/all.css" integrity="sha384-lKuwvrZot6UHsBSfcMvOkWwlCMgc0TaWr+30HWe3a4ltaBwTZhyTEggF5tJv8tbt" crossorigin="anonymous">
    <link href="./Selamat Datang - Di Portal E-Auditee Badan Pemeriksan Keuangan Indonesia -_files/css" rel="stylesheet">
    <link rel="stylesheet" href="./Selamat Datang - Di Portal E-Auditee Badan Pemeriksan Keuangan Indonesia -_files/all(1).css" integrity="sha384-50oBUHEmvpQ+1lW4y57PTFmhCaXp0ML5d60M1M7uH2+nqUivzIebhndOJK28anvf" crossorigin="anonymous">
    <link rel="stylesheet" href="./Selamat Datang - Di Portal E-Auditee Badan Pemeriksan Keuangan Indonesia -_files/dataTables.bootstrap4.min.css">
    <!-- App Styles -->
    <link href="./Selamat Datang - Di Portal E-Auditee Badan Pemeriksan Keuangan Indonesia -_files/098498fad9c5ca6442dcf74a000e83fe-1592889129" rel="stylesheet">

    <!-- Matomo -->
    <script type="text/javascript" async="" src="./Selamat Datang - Di Portal E-Auditee Badan Pemeriksan Keuangan Indonesia -_files/recaptcha__en.js.download" crossorigin="anonymous" integrity="sha384-XtymsJC8H3wYh57vnHxIWSTq9LJf2d3w3WVjR2gR+rDtBuWO8zdvO/s6O6Cli/Oe"></script>
    <script async="" src="./Selamat Datang - Di Portal E-Auditee Badan Pemeriksan Keuangan Indonesia -_files/analytics.js.download"></script>
    <script type="text/javascript" async="" defer="" src="./Selamat Datang - Di Portal E-Auditee Badan Pemeriksan Keuangan Indonesia -_files/matomo.js.download"></script>
    ...
    <noscript>
        <p><img src="//webanalytics.bpk.go.id/matomo.php?idsite=14&amp;rec=1" style="border:0;" alt="" /></p>
    </noscript>
    <!-- End Matomo Code -->
    ...
    <style type="text/css">
        ...
        :root a[href^="https://syndication.dynsrvtbg.com/splash.php?"] {
...
<body class="">
    <header class="head-siptl">
        <nav class="navbar navbar-expand-lg navbar-light fixed-top bg-primary">
            <div class="container-fluid">
                <a class="navbar-brand" href="https://eauditee.bpk.go.id/dashboard">
                    <img src="./Selamat Datang - Di Portal E-Auditee Badan Pemeriksan Keuangan Indonesia -_files/logo-header.png" class="img-logo" alt="">
                </a>
    ...
    <section class="home">
        <div class="cover-home" id="hg" style="background-image: url(https://eauditee.bpk.go.id/themes/siptl/assets/images/cover-home.png)">
            <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-7">
                            <div class="content-text">
                                ...
                                <p>Portal e-Auditee adalah aplikasi yang disediakan oleh BPK kepada entitas pemeriksaan BPK
                                    dalam rangka mendukung pelaksanaan Tugas dan Wewenang BPK sesuai dengan Undang-undang yang berlaku.</p>
                            </div>
                        </div>
                        <div class="col-md-5">
                            <form method="POST" action="https://eauditee.bpk.go.id/" accept-charset="UTF-8" data-request="onSignin" class="login content"><input name="_session_key" type="hidden" value="2h5WtJg7GrsbebxS2lSOFnZ9Kugmob2nAYNm5o9d"><input name="_token" type="hidden" value="wCZFZLAejzArrqxk8bAJe3LEexLhYZbQMEM4BR6z">
                                <div class="card">
                                    <div class="card-body">
                                        <h2 class="text-dark py-3">Log in </h2>
                                        <div class="form-group form-email">
                                            <input type="email" name="email" class="form-control border-0" id="email" placeholder="example@domain.com">
                                            <label for="email">Email</label>
                                        </div>
                                        <div class="form-group form-pas">
                                            <span class="far fa-eye hidden-password"></span>
                                        ...
                                        <div class="card p-2" id="captcha">
                                            <div class="row m-0 align-items-end">
                                                <div class="d-flex align-items-start">
                                                    <img src="./Selamat Datang - Di Portal E-Auditee Badan Pemeriksan Keuangan Indonesia -_files/captcha-create" alt="gambar" class="home-capcha-img mr-1" id="img-captcha">
                                                    <button type="button" id="btn-captcha" data-request="onRefreshCaptcha" data-request-success="$(&#39;#img-captcha&#39;).attr(&#39;src&#39;, &#39;https://eauditee.bpk.go.id/captcha-create?&#39;+(new Date()).getTime())" data-request-update="&#39;re-captcha&#39;:&#39;#captcha&#39;" class="mr-3 mt-1 btn-sync">
                                                        <i class="fas fa-sync-alt f-12"></i>
                                                    </button>
                                                </div>
                                                <div>
                                                    <label for="" class="m-0"><i style="color: #6e777f;" class="f-14">Answer In The Box</i></label>
                                                    <input type="number" name="capcha" class="form-control text-center" id="pas" placeholder="...." required="">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row pt-2">
                                            ...
                                            <div class="col-md-6 text-right">
                                                <a href="https://eauditee.bpk.go.id/lupa-password" class="text-blue"> Lupa Password?</a>
                                            </div>
                                        </div>
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-md-3 py-2">
                                                <a type="button " class="btn btn-outline-primary btn-md" href="https://eauditee.bpk.go.id/home-regist">Daftar</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <div style="background-color: white; height: 320px; display: block;"></div>
    </section>


    <script src="./Selamat Datang - Di Portal E-Auditee Badan Pemeriksan Keuangan Indonesia -_files/375e4c500cf0bcde928d32fcdeaed271-1576222243"></script>

    <script src="./Selamat Datang - Di Portal E-Auditee Badan Pemeriksan Keuangan Indonesia -_files/api.js.download" async="" defer=""></script>
    <script>
        $("#pas").on("keyup", function() {
            if ($(this).val())
                $(".fa-eye").show();
            else
                $(".fa-eye").hide();
