...
function untarkiman(thisNumber) {
  if (thisNumber != "") {
    var newNumber = parseFloat(thisNumber.replace(/,/g, ""));
    return newNumber;
  }
...
(function (window) {
  ...
  NotificationFx.prototype._init = function () {
    ...
    this.options.wrapper.insertBefore(
      this.ntf,
      this.options.wrapper.firstChild
    );
...
function notify(messages) {
  ...
  var notification = new NotificationFx({
    message:
      '<span class="fs1" aria-hidden="true" data-icon="&#xe0f4;"> </span><p>' +
      messages +
      "</p>",
    layout: "bar",
    effect: "slidetop",
