                    ...
                    <div class="well">
                        <div class="widget-body">
                            ...
                            <form action="<?= base_url('sebab/save'); ?>" method="POST" enctype="multipart/form-data" class="form-horizontal no-margin">
                                ...
                                <?= input_text($field_name = 'jenis_sebab', $label = 'Jenis Sebab', $value = '', $required = true, $readonly = false, $disabled = false); ?>
                                <?= input_number($field_name = 'nilai_sebab', $label = 'Nilai Sebab', $value = '', $required = true, $readonly = false, $disabled = false); ?>
