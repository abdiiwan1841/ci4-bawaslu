                    ...
                    <div class="well">
                        <div class="widget-body">
                            ...
                            <form action="#" method="POST" enctype="multipart/form-data" class="form-horizontal no-margin">
                                ...
                                <?= input_textarea($field_name = 'alasan_tidak_di_tl', $label = 'Alasan / Keterangan Tidak Dapat di TL', $value = '', $required = false, $readonly = true, $disabled = false); ?>
                                <?= input_file($field_name = 'lampiran', $label = 'Lampiran', $file_name = $data->lampiran_tidak_di_tl, $required = false, $readonly = true, $path = 'uploads', $tips = '*.jpg | .png |.pdf |.xls | .xlsx |.doc | .docx'); ?>
