            ...
            <div class="widget-body">
                <div id="wizard" class="bwizard clearfix">
                    <ol class="bwizard-steps clearfix clickable" role="tablist">
                        ...
                        <li role="tab" aria-selected="true" class="active" style="z-index: 3;"><span class="label badge-inverse">2</span><a href="<?= base_url('temuan/index/' . $id_temuan) ?>" class="hidden-phone">Temuan</a></li>
                        <li role="tab" aria-selected="false" class="active" style="z-index: 2;"><span class="label badge-inverse">3</span><a href="#step3" class="hidden-phone">Rekomendasi</a></li>
