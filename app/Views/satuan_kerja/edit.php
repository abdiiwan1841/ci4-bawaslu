    ...
    <div class="span6">
        <div class="widget">
            ...
            <div class="widget-body">
                ...
                <?php endif; ?>
                <form action="<?= base_url('satuankerja/update/' . $data->id); ?>" method="POST" enctype="multipart/form-data" class="form-horizontal no-margin">

                    <?= csrf_field(); ?>
                    <?= input_text($field_name = 'kode_satuan_kerja', $label = 'Kode Satuan Kerja', $value = $data->kode_satuan_kerja, $required = true, $readonly = true, $disabled = false); ?>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls controls-row">
                            <div class="input-append">
                                <input type="hidden" name="id_pimpinan" id="id_pimpinan" value="<?= $data->id_pimpinan; ?>">
                                <input type="text" name="nama_pimpinan" id="nama_pimpinan" value="<?= $data->nama_pimpinan; ?>" class="input-large" autocomplete="off" placeholder="Nama Pimpinan">
                    ...
                    <?= input_text($field_name = 'nip', $label = 'NIP Pimpinan', $value = $data->nip, $required = true, $readonly = true, $disabled = false); ?>
