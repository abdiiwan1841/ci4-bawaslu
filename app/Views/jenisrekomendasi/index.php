...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var table = $('#datatables').DataTable({
            "dom": 'Bfrtip',
            "buttons": [
                <?php if (in_array('jenisrekomendasi/create', session()->get('user_permissions'))) : ?> {
                        text: 'Create New',
                        action: function(e, dt, node, config) {
                            window.location.href = "<?= base_url('/jenisrekomendasi/create'); ?>";
                        }
                    }
                <?php endif; ?>
            ],
            ...
            "ajax": "<?= base_url('jenisrekomendasi/datatables'); ?>",
