            ...
            <div class="widget-body">
                <div id="wizard" class="bwizard clearfix">
                    <ol class="bwizard-steps clearfix clickable" role="tablist">
                        ...
                        <li role="tab" aria-selected="true" class="active" style="z-index: 2;"><span class="label badge-inverse">3</span><a href="<?= base_url('rekomendasi/index/') ?>" class="hidden-phone">Rekomendasi</a></li>
