        ...
        <div class="widget">
            ...
            <div class="widget-body">
                ...
                <form action="#" method="POST" enctype="multipart/form-data" class="form-horizontal no-margin">
                    ...
                    <?= input_text($field_name = 'id', $label = 'Directorate ID', $value = $data->id, $required = true, $readonly = true, $disabled = false); ?>
                    <?= input_text($field_name = 'directorate_name', $label = 'Directorate Name', $value = $data->directorate_name, $required = true, $readonly = true, $disabled = false); ?>
