            ...
            <div class="widget-body">
                <div id="wizard" class="bwizard clearfix">
                    <ol class="bwizard-steps clearfix clickable" role="tablist">
                        ...
                        <li role="tab" aria-selected="true" class="active" style="z-index: 1;"><span class="label badge-inverse">7</span><a href="<?= base_url('bukti/index/' . session()->get('id_tindak_lanjut')) ?>" class="hidden-phone">Bukti</a></li>
                    </ol>
                    ...
                    <div class="well">
                        <div class="widget-body">
                            ...
                            <?php endif; ?>
                            <form action="<?= base_url('bukti/update/' . $data->id); ?>" method="POST" enctype="multipart/form-data" class="form-horizontal no-margin">
