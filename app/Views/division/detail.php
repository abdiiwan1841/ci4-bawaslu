        ...
        <div class="widget">
            ...
            <div class="widget-body">
                ...
                <form action="#" method="POST" enctype="multipart/form-data" class="form-horizontal no-margin">
                    ...
                    <?= input_text($field_name = 'division_code', $label = 'Division Code', $value = $data->division_code, $required = true, $readonly = true, $disabled = false); ?>
                    <?= input_text($field_name = 'division_name', $label = 'Division Name', $value = $data->division_name, $required = true, $readonly = true, $disabled = false); ?>
