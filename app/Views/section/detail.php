        ...
        <div class="widget">
            ...
            <div class="widget-body">
                ...
                <form action="#" method="POST" enctype="multipart/form-data" class="form-horizontal no-margin">
                    ...
                    <?= input_text($field_name = 'section_code', $label = 'Section Code', $value = $data->section_code, $required = true, $readonly = true, $disabled = false); ?>
                    <?= input_text($field_name = 'section_name', $label = 'Section Name', $value = $data->section_name, $required = true, $readonly = true, $disabled = false); ?>
