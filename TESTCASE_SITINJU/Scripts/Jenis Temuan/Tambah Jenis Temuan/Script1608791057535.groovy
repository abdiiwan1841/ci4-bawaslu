...
WebUI.setText(findTestObject('Jenis Temuan/From Create/Kode'), '1234567890')

WebUI.setText(findTestObject('Jenis Temuan/From Create/Deskripsi'), 'Merugikan Perusahaan dan Negara')
